...
bioGeoIslDbox= function () 
{
    ...
    tkgrid(tklabel(top, text = "Mainland Number of Species"), 
        PEntry, sticky = "w")
    tkgrid(tklabel(top, text = "Extinction/Area coeficient "), 
        bEntry, sticky = "w")
    tkgrid(tklabel(top, text = "Extinction/Distance coeficient "), 
        hEntry, sticky = "w")
    tkgrid(tklabel(top, text = "Colonization/Area coeficient "), 
        fEntry, sticky = "w")
    tkgrid(tklabel(top, text = "Colonization/Distance coeficient "), 
        dEntry, sticky = "w")
...
extGameDbox=function () 
{
    ...
    mVarSlider <- tkscale(top, from = 10, to = 100, showvalue = TRUE, 
        variable = mVar, resolution = 10, orient = "horizontal")
    apVar <- tclVar(1)
